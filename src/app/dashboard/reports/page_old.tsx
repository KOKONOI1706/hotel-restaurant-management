      ...
      try {
        ...
        if (data.success) {
          ...
          const reportData: ReportData = {
            revenue: {
              total: dashboardData.stats.yearlyRevenue || 0,
              monthly: [], // This would need to be calculated from bookings data
              daily: [], // This would need to be calculated from bookings data
              byCategory: [
                { category: 'Phòng nghỉ', amount: dashboardData.stats.monthlyRevenue || 0, percentage: 100 },
              ]
            },
        occupancy: {
          rate: 78.5,
