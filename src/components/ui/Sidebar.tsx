...
const navigation = [
  ...
  { name: 'Phòng', href: '/dashboard/rooms', icon: BuildingStorefrontIcon },
        ...
        <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              <h1 className="text-lg font-semibold text-gray-800">Hệ thống Khách sạn</h1>
            </div>
          ...
          <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
            ...
            >
              <ArrowRightOnRectangleIcon className="text-gray-400 mr-3 h-6 w-6" />
              Đăng xuất
            </button>
          </div>
        </div>
          ...
          <div className="flex flex-col h-0 flex-1 border-r border-gray-200 bg-white">
            <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
              <div className="flex items-center flex-shrink-0 px-4">
                <h1 className="text-xl font-bold text-gray-800">Hệ thống Khách sạn</h1>
              </div>
