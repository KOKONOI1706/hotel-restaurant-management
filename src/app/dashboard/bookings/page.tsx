...
export default function BookingsPage() {
  ...
  // Hiển thị tổng tiền (phân biệt giữa tính sẵn và thời gian thực)
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-yellow-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    {selectedBookingDetail.status === 'checked-out' && selectedBookingDetail.baseAmount && (
                      <div className="bg-blue-50 p-3 rounded-lg mt-3">
                        <div className="flex justify-between">
                          ...
                          <span className="font-bold text-blue-800">{selectedBookingDetail.baseAmount.toLocaleString('vi-VN')} VND</span>
                        </div>
                        
                        {selectedBookingDetail.realTimeCalculation && !selectedBookingDetail.usePreCalculated && (
                    ...
                    {selectedBookingDetail.extraCharges && selectedBookingDetail.extraCharges > 0 && (
                      <div className="flex justify-between">
